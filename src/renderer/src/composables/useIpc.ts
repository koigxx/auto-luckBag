...
export function useIpc() {
  ...
  async function startAutoRun(options: {
    ...
    autoRunState.value = {
      ...
      scanIntervalSeconds: options.scanIntervalSeconds || 35,
      ...
      enterBeforeSeconds: options.enterBeforeSeconds || 65,
      candidatePoolLimit: Math.min(5, Math.max(1, options.candidatePoolLimit || 4)),
